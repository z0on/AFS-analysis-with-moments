...
lower_bound = [1e-3,1e-3, 1e-3,1e-3,1e-5,1e-5,1e-5,1e-5,1e-4,1e-5]
...
print "RESULT","SCI",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta,uncert
