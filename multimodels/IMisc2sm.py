...
lower_bound = [1e-3,1e-3,1e-3,1e-3,1e-3,1e-3, 1e-3,1e-3,1e-5,1e-5,1e-4,1e-5]
...
moments.ModelPlot.plot_model(plot_mod, save_file="IMisc2sm_"+ind+"_"+sys.argv[1]+".png",pop_labels=pop_ids, nref=theta/(4*mu), gen_time=gtime, gen_time_units="KY", reverse_timeline=True)
