...
moments.ModelPlot.plot_model(plot_mod, save_file="sc3iesm_"+ind+".png", pop_labels=pop_ids, nref=theta/(4*mu), gen_time=gtime, gen_time_units="KY", reverse_timeline=True)
