...
import sys
infile=sys.argv[1]
params=array([  float(sys.argv[2]),   float(sys.argv[3]),  float(sys.argv[4])])
...
print "gj1f",ind,sys.argv[1],' ll: ', ll_model,' p: ', poptg, " t: ",theta

moments.Plotting.plot_1d_comp_multinom(model, data)

plt.savefig("gj1f_"+ind+"_"+sys.argv[1]+'.pdf')
