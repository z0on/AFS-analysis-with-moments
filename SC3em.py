...
# split, three epochs in each pop, asymmetric migration only in second epoch
# n(para): 12
...
#    p_misid: proportion of misidentified ancestral states
    nu1_1, nu2_1, nu1_2,nu2_2,nu1_3,nu2_3,T1, T2, T3,m12_2, m21_2, p_misid = params
...
moments.ModelPlot.plot_model(plot_mod, save_file="sc3em_"+ind+".png", pop_labels=pop_ids, nref=theta/(4*mu), gen_time=gtime, gen_time_units="KY", reverse_timeline=True)
