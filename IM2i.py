...
lower_bound = [1e-3,1e-3,1e-3,1e-3, 1e-3,0.01,0.01,0.01,0.01,1e-4,1e-5]
...
print "IM2i",ind,sys.argv[1],sys.argv[2],sys.argv[3],' ll: ', ll_model,' p: ', poptg, " t: ",theta, 'uncert: ', uncert
