...
#    migs.i = lambda t: np.array([[0, Fi*m12_func(t)], [Fi*m21_func(t), 0]])
    ...
    fss.integrate([Fs*nu1_1, Fs*nu2_1], T1, m = np.array([[0, 0], [0, 0]]))    
...
par_labels = ('nu1_0','nu2_0','nu1','nu2','T1','T2','m12','m21','Fs','F_gs','f_misid')
...
print( "RESULT","scIMSmne",ind,len(par_labels),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
