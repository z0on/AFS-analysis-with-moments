...
# Fs: factor of Ne reduction (0.001 - 0.999)
    nu1_1,nu2_1,T,Fs,P,p_misid = params
    ...
    fsi.integrate([nu1_1*Fs, nu2_1*Fs], T, m = np.array([[0, 0], [0, 0]]))
...
print( "RESULT","s2nmS",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
