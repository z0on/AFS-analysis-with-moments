...
upper_bound = [100, 100, 100,100,100,100,200,200,0.99999,0.99999,0.25]
lower_bound = [1e-5,1e-5, 1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-3,1e-5,1e-5]
...
print( "RESULT","s2imne",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
