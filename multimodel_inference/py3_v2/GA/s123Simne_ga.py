...
# Fs: factor of Ns reduction (1e-5 - 0.999)
    nu0,nu1_1,nu2_1,nu1_2,nu2_2,T0,T1,T2,m12_1,m21,m12,Fi,Pi,Fs,Ps,p_misid = params
...
upper_bound = [100, 100,100, 100,100,100,100,100,200,200,0.999,0.999,0.999,0.999,0.25]
lower_bound = [1e-5,1e-5,1e-5,1e-5, 1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-1,1e-5,1e-5]
if len(sys.argv)==9:
