...
# Fi: factor of migration reduction (1e-5 - 0.999)
    nu0,nu1_1,nu2_1,nu1_2,nu2_2,T0,T1,T2,m12,m21,Fi,P = params
...
par_labels = ('nu0','nu1_1','nu2_1','nu1_2','nu2_2','T0','T1','T2','m12','m21','F_isl','F_gen')
...
print( "RESULT","s123imne",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
