...
# Fi: factor of migration reduction (1e-5 - 0.999)
    ...
    fsi.integrate([nu1_2*Fs, nu2_2*Fs], T2, m = np.array([[0, m12*Fs], [m21*Fs, 0]]))
...
print( "RESULT","s103S",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
