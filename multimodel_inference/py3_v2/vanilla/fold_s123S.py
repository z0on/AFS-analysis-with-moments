...
# Fi: factor of migration reduction (1e-5 - 0.999)
    nu0,nu1_1,nu2_1,nu1_2,nu2_2,T0,T1,T2,m12_1,m21_1,m12_2,m21_2,Fs,P = params
...
upper_bound = [100, 100, 100,100,100,100,100,100,200,200,200,200,0.999,0.999]
...
par_labels = ('nu0','nu1_1','nu2_1','nu1_2','nu2_2','T0','T1','T2','m12_1','m21_1','m12_2','m21_2','Fs','Fgs')
