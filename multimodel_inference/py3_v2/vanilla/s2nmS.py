...
lower_bound = [1e-5,1e-5, 1e-5,1e-5,1e-5,1e-5,1e-1,1e-5,1e-5]
'''
if len(sys.argv)==9:
...
par_labels = ('nu1_1','nu2_1','nu1_2','nu2_2','T1','T2','F_s','F_gs','f_misid')
...
print( "RESULT","s2nmS",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
