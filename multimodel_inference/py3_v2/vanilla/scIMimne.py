...
def IMi(params, ns):
    ...
    """
    nu1_0,nu2_0,nu1,nu2,T1,T2,m12,m21,Fi,P,p_misid = params
...
func=IMi
upper_bound = [100,100,100, 100, 10, 10,100,100,0.999,0.999,0.25]
...
par_labels = ('nu1_0','nu2_0','nu1','nu2','T1','T2','m12','m21','F_isl','F_gen','f_misid')
...
print( "RESULT","scIMimne",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
