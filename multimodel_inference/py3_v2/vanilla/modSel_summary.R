...
'
setwd("/home/cmonstr/Dropbox/Documents/perl_bin/moments_scripts/multimodel_inference/py3_v2/vanilla")
 modselResult="ny.modsel"
 path2models="~/Dropbox/Documents/perl_bin/moments_scripts/multimodel_inference/py3_v2/vanilla/"
 folded=FALSE
