...
def IMSi(params, ns):
    ...
    """
    nu1_0,nu2_0,nu1,nu2,T,m12,m21,Fs,Ps,Fi,Pi = params
...
func=IMSi
upper_bound = [100,100,100, 100, 10, 100,100,0.999,0.999,0.999,0.999]
lower_bound = [1e-3,1e-3,1e-3,1e-3, 1e-3,1e-5,1e-5,1e-4,1e-4,1e-4,1e-4]
...
par_labels = ('nu1_0','nu2_0','nu1','nu2','T','m12','m21','Fi','F_gi','Fs','F_gs')
...
print( "RESULT","IMSimne",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
