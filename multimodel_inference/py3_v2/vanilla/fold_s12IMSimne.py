...
def s12IMSi(params, ns):
    ...
    """
    nu0,nu1_0,nu2_0,nu1,nu2,T0,T2,m12,m21,Fs,Ps,Fi,Pi = params
...
func=s12IMSi
upper_bound = [100,100,100,100, 100, 10,10, 100,100,0.999,0.999,0.999,0.999]
lower_bound = [1e-3,1e-3,1e-3,1e-3,1e-3, 1e-3,1e-3,1e-5,1e-5,1e-4,1e-4,1e-4,1e-4]
...
par_labels = ('nu0','nu1_0','nu2_0','nu1','nu2','T0','T2','m12','m21','Fi','F_gi','Fs','F_gs')
