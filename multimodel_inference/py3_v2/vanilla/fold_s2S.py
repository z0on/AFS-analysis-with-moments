...
# Fs: factor of Ne reduction (1e-5 - 0.999)
    nu1_1,nu2_1,nu1_2,nu2_2,T1,T2,m12_1,m21_1,m12_2,m21_2,Fs,P = params
...
func=sc2S
upper_bound = [100, 100, 100,100,100,100,200,200,200,200,0.999,0.999]
...
par_labels = ('nu1_1','nu2_1','nu1_2','nu2_2','T1','T2','m12_1','m21_1','m12_2','m21_2','F_s','F_gs')
...
print( "RESULT","s2S",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
