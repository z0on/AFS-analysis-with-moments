...
def s12IMi(params, ns):
    ...
    """
    nu0,nu1_0,nu2_0,nu1,nu2,T0,T2,m12,m21,p_misid = params
...
func=s12IMi
upper_bound = [100,100,100, 100,100, 10,10, 100,100,0.25]
lower_bound = [1e-3,1e-3,1e-3,1e-3, 1e-3,1e-3,1e-3,1e-5,1e-5,1e-5]
...
par_labels = ('nu0','nu1_0','nu2_0','nu1','nu2','T0','T2','m12','m21','f_misid')
...
print( "RESULT","s12IMmne",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
