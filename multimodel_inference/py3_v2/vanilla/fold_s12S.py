...
# Fs: factor of Ne reduction (1e-5 - 0.999)
    nu1,nu1_2,nu2_2,T1,T2,m12,m21,Fs,P = params
...
par_labels = ('nu1','nu1_2','nu2_2','T1','T2','m12','m21','F_ne','F_gen')
...
print( "RESULT","s12S",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
