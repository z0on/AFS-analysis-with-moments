...
# Fs: factor of Ne reduction (1e-5 - 0.999)
    nu1,nu1_2,nu2_2,T1,T2,Fs,P = params
...
func=sc3ei
upper_bound = [100,100,100,100,100,0.999,0.999]
lower_bound = [1e-5, 1e-5,1e-5,1e-5,1e-5,1e-1,1e-5]
'''
if len(sys.argv)==9:
...
par_labels = ('nu1','nu1_2','nu2_2','T1','T2','F_ne','F_gen')
...
moments.ModelPlot.plot_model(plot_mod, save_file="s12nmS_"+ind+".png", pop_labels=pop_ids, nref=theta/(4*mu), draw_scale=False, gen_time=gtime, gen_time_units="KY", reverse_timeline=True)

# bootstrapping for SDs of params and theta

# printing parameters and their SDs
print( "RESULT","s12nmS",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
                                    
# plotting quad-panel figure witt AFS, model, residuals:
moments.Plotting.plot_2d_comp_multinom(model, data, vmin=0.1, resid_range=3,
                                    pop_ids =pop_ids)
plt.savefig("s12nmS_"+ind+"_"+sys.argv[1]+"_"+sys.argv[2]+"_"+sys.argv[3]+"_"+sys.argv[4]+"_"+sys.argv[5]+'.pdf')
