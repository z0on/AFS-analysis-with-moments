#!/usr/bin/env python3
'''
   Isolation-with-migration after secondary contact:
    split into two arbtrary sizes with no migration at T1
    asymmetric migration and exponential size change start after T2
    Migration scales with the size of the source population
...
def IM(params, ns):
    ...
    """
    nu1_0,nu2_0,nu1,nu2,T1,T2,m12,m21 = params
...
func=IM
upper_bound = [100,100,100, 100, 10, 10, 100,100]
...
par_labels = ('nu1_0','nu2_0','nu1','nu2','T1','T2','m12','m21')
...
print( "RESULT","scIMmne",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
