...
#    p_misid: proportion of misidentified ancestral states
    nu1_1, nu2_1, nu1_2,nu2_2,nu1_3,nu2_3,T1, T2, T3,Fs, P, p_misid = params
    ...
    fsi.integrate([nu1_1, nu2_1*Fs], T1, m = np.array([[0, 0], [0, 0]]))
    fsi.integrate([nu1_2, nu2_2*Fs], T2, m = np.array([[0, 0], [0, 0]]))
    fsi.integrate([nu1_3, nu2_3*Fs], T3, m = np.array([[0, 0], [0, 0]]))

    fs2=P*fsi+(1-P)*fs
    return (1-p_misid)*fs2 + p_misid*moments.Numerics.reverse_array(fs2)
 
func=sc3ei
upper_bound = [100, 100, 100,100,100, 100, 100, 100,100, 200,0.999,0.999,0.25]
lower_bound = [1e-3,1e-3, 1e-3,1e-3,1e-3,1e-3,1e-3,1e-3,1e-3,1e-5,1e-3,0.001,1e-5]
