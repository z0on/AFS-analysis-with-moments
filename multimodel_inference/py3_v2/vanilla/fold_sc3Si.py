...
# Fs: factor of Ns reduction (1e-5 - 0.999)
    nu1_0,nu2_0,nu1_1,nu2_1,nu1_2,nu2_2,T0,T1,T2,m12_1,m21_1,m12_2,m21_2,Fi,Pi,Fs,Ps = params
...
upper_bound = [100, 100,100, 100, 100,100,10,10,10,200,200,200,200,0.999,0.999,0.999,0.999]
lower_bound = [1e-5,1e-5, 1e-5,1e-5,1e-5, 1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5,1e-5]
'''
if len(sys.argv)==9:
...
par_labels = ('nu1_0','nu2_0','nu1_1','nu2_1','nu1_2','nu2_2','T0','T1','T2','m12_1','m21_1','m12_2','m21_2','Fi','Fgi','Fs','Fgs')
