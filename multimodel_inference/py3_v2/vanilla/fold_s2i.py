...
# Fi: factor of migration reduction (1e-5 - 0.999)
    nu1_1,nu2_1,nu1_2,nu2_2,T1,T2,m12_1,m21_1,m12_2,m21_2,Fi,P = params
...
par_labels = ('nu1_1','nu2_1','nu1_2','nu2_2','T1','T2','m12_1','m21_1','m12_2','m21_2','F_isl','F_gen')
...
print( "RESULT","s2i",ind,len(upper_bound),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
