...
def s10IMi(params, ns):
    ...
    """
    nu0,nu1_0,nu2_0,nu1,nu2,T0,T1,T2,m12,m21,p_misid = params
...
func=s10IMi
upper_bound = [100,100,100,100, 100, 10,10,10, 100,100,0.25]
...
par_labels = ('nu0','nu1_0','nu2_0','nu1','nu2','T0','T1','T2','m12','m21','f_misid')
