...
topq=0.75       top quantile to summarize. For example 0.75 means that only the best-likelihood 90% 
...
if(length(topq)>0) { topq=as.numeric(sub("topq=","", commandArgs()[topq])) } else { topq=0.75 }
...
folded=F
topq=0.75
path2models="/home/misha/Dropbox/Documents/perl_bin/moments_scripts/multimodel_inference/py3_v2/vanilla/"
