...
def IM2iSC(params, ns):
    ...
    """
    nu1_0,nu2_0,nu1,nu2,T,T0,m,p_misid = params
...
func=IM2iSC
upper_bound = [100,100,100, 100, 10,10, 200,0.25]
...
moments.ModelPlot.plot_model(plot_mod, save_file="IMscsm_"+ind+"_"+sys.argv[1]+".png",pop_labels=pop_ids, nref=theta/(4*mu), draw_scale=False, gen_time=gtime, gen_time_units="KY", reverse_timeline=True)
...
print "RESULT","IMscsm",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta,uncert
                                    
# plotting quad-panel figure witt AFS, model, residuals:
moments.Plotting.plot_2d_comp_multinom(model, data, vmin=1, resid_range=3,
                                    pop_ids =pop_ids)
plt.savefig("IMscsm_"+ind+"_"+sys.argv[1]+"_"+sys.argv[2]+"_"+sys.argv[3]+"_"+sys.argv[4]+"_"+sys.argv[5]+'.pdf')
