...
def IM2iSC(params, ns):
    ...
    """
    nu1_0,nu2_0,nu1,nu2,T,T0,m12,m21,m12i,m21i,P = params
...
func=IM2iSC
upper_bound = [100,100,100, 100, 10,10, 200,200,200,200,0.9999]
lower_bound = [1e-15,1e-15,1e-15,1e-15, 1e-15,1e-15,1e-5,1e-5,1e-5,1e-5,1e-4]
...
print "RESULT","IMisc",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta,uncert
