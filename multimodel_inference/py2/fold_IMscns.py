...
lower_bound = [1e-3,1e-3,1e-5,1e-5]
...
#moments.ModelPlot.plot_model(plot_mod, save_file="IMscns_"+ind+"_"+sys.argv[1]+".png",pop_labels=pop_ids, nref=theta/(4*mu), draw_scale=False, gen_time=gtime, gen_time_units="KY", reverse_timeline=True)

# bootstrapping for SDs of params and theta

# printing parameters and their SDs
print "RESULT","IMscns",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta
