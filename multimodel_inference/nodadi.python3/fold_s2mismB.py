...
#    p_misid: proportion of misidentified ancestral states
    nu1_1, nu2_1,T, m,m12i,m21i, P = params
...
lower_bound = [1e-3,1e-3,1e-3,1e-3,1e-5,1e-5,1e-3]
...
moments.ModelPlot.plot_model(plot_mod, save_file="s2mismB_"+ind+".png", pop_labels=pop_ids, nref=theta/(4*mu), draw_scale=False, gen_time=gtime, gen_time_units="KY", reverse_timeline=True)

# bootstrapping for SDs of params and theta

# printing parameters and their SDs
print( "RESULT","s2mismB",ind,len(params),ll_model,sys.argv[1],sys.argv[2],sys.argv[3],poptg,theta)
